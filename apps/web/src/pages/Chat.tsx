      ...
      <div className="flex-1 glass rounded-2xl overflow-hidden flex flex-col min-h-0">
        ...
        >
          ...
          <input
            ...
            className="shell-focus-ring flex-1 bg-gray-900/60 border border-gray-700 rounded-xl px-4 py-3 text-sm placeholder-gray-500 focus-visible:ring-2 focus-visible:ring-cyan-500/50 focus:outline-none"
            disabled={isLoading}
            autoComplete="off"
          />
          <button
