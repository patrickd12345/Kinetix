...
const RunItem = memo(({ run, unitSystem, onAnalyze, onDelete, isAnalyzing }: RunItemProps) => {
  return (
        ...
        <div className="text-right ml-4">
          ...
          <div className="flex gap-2 mt-2 justify-end">
            <button
              ...
              aria-label="Analyze with AI Coach"
            >
              <Sparkles size={14} />
            </button>
            <button
...
export default function History() {
  ...
  const handleAnalyzeRun = useCallback(async (run: RunRecord) => {
